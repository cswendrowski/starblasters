...
const SPECS := [
	...
	"res://scenes/projectiles/projectile_wave.tscn",     # magenta orb
	"res://scenes/projectiles/projectile_bolt.tscn",  # purple diamond
	"res://scenes/projectiles/projectile_bolt.tscn",   # cyan tracer
]
