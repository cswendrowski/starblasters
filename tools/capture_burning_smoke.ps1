...
& $GODOT --path $Repo -s 'res://tools/capture_burning_smoke.gd' 2>&1
...
$FilterGraph = 'scale=1440:810:flags=lanczos,split[s0][s1];[s0]palettegen=stats_mode=diff[p];[s1][p]paletteuse=dither=bayer:bayer_scale=5'
