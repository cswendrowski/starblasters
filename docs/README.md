...
| Hardpoint v2 — Payload × Delivery × Trigger | **Phase A launcher→gun collapse SHIPPED 2026-07-05, rest PROPOSED** — [`hardpoint_v2_design_2026-07-05.md`](hardpoint_v2_design_2026-07-05.md) (decouple the axes: launcher→gun payload ✅, beam→payload, turret→delivery toggle, rings→delivery; phased A/B/C) |
