...
| Hardpoint v2 — Payload × Delivery × Trigger | **Phases A + B SHIPPED 2026-07-05 (Phase C not started)** — [`hardpoint_v2_design_2026-07-05.md`](hardpoint_v2_design_2026-07-05.md) (decouple the axes: launcher→gun payload ✅, beam→payload ✅, turret honors all firing settings + projectile payload ✅; rings→delivery pending. Deferred-cosmetic: retire turret/launcher/beam *kinds* for a Payload+Delivery schema, beam×turret) |
