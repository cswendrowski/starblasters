**✅ ARCHIVED 2026-06-15 — this shipped; historical design doc.** Current behavior: all 7 bosses shipped under scripts/enemies/bosses/.
Do not cite as a to-do.
> Name aliases: Aegis = boss_aegis.gd (scene boss_sentinel.tscn); Lash = boss_reaver.gd.
