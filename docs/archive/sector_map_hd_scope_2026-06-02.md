**✅ ARCHIVED 2026-06-15 — this shipped; historical design doc.** Current behavior: scripts/screens/sector_map_hd.gd (the live HD sector map).
...
See `docs/archive/sector_map_hd_PORT_HANDOFF.md` for the detailed handoff.
