**✅ ARCHIVED 2026-06-15 — this shipped; historical design doc.** Current behavior: built: scripts/effects/recycle_controller.gd (wired into enemy_core) + RecycleTuner.
