**⚠️ ARCHIVED 2026-06-15 — historical snapshot, not current design.** Superseded by: docs/weapon_dps_report_2026-06-13.md (live numbers); stats now live in resources/weapons/*.tres.
