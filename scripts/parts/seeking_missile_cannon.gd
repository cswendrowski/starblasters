...
# Seeking Missile launcher. Slow cadence, slow projectile, but the
# missile homes onto the nearest non-shielded enemy. Highest per-shot
# damage in the CANNON slot; great against tanky elites + bosses.
...
func _init() -> void:
	...
	description = "Tracks the nearest enemy. Slow cadence, heavy damage."
