...
const STRINGS := {
	...
	"res://scenes/enemies/enemy_mine_cluster.tscn": {"name": "Cluster Mine", "codex": "TBD"},
	"res://scenes/enemies/enemy_mine_cluster_smart.tscn": {"name": "Smart Cluster Mine", "codex": "TBD"},
	...
	"res://scenes/enemies/enemy_smart_bomblet.tscn": {"name": "Smart Bomblet", "codex": "TBD"},
