...
const STRINGS := {
	...
	"res://scenes/enemies/enemy_mine_cluster.tscn": {"name": "mine_cluster", "codex": "TBD"},
	"res://scenes/enemies/enemy_mine_cluster_smart.tscn": {"name": "mine_cluster_smart", "codex": "TBD"},
	"res://scenes/enemies/enemy_mine_shield.tscn": {"name": "mine_shield", "codex": "TBD"},
	"res://scenes/enemies/enemy_mine_smart.tscn": {"name": "mine_smart", "codex": "TBD"},
	"res://scenes/enemies/enemy_shield_pylon.tscn": {"name": "shield_pylon", "codex": "TBD"},
	"res://scenes/enemies/enemy_smart_bomblet.tscn": {"name": "smart_bomblet", "codex": "TBD"},
	...
	"res://scenes/enemies/tether_mine.tscn": {"name": "tether_mine", "codex": "TBD"},
}
