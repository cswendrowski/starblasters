...
const ENTRIES = [
	...
	{"path": "res://scenes/enemies/core/enemy_cutter.tscn",   "name": "Cutter",   "tier": "Uncommon", "blurb": "Side-entry strafer. Alternates flanks, fires fast and exits."},
	{"path": "res://scenes/enemies/core/enemy_weaver.tscn",   "name": "Weaver",   "tier": "Uncommon", "blurb": "Paired center-out arc with aimed shots."},
	{"path": "res://scenes/enemies/core/enemy_hover.tscn",    "name": "Hover",    "tier": "Uncommon", "blurb": "Loiters at altitude, picks at you with single shots."},
	{"path": "res://scenes/enemies/factions/corporate/enemy_skirmisher.tscn", "name": "Skirmisher", "tier": "Uncommon", "blurb": "Advances, retreats, fires aimed bursts. Aggressive."},
	{"path": "res://scenes/enemies/factions/corporate/enemy_strafer.tscn",  "name": "Strafer",  "tier": "Common", "blurb": "Head-on pass: dives in, fires a tracer burst, breaks off to the bottom."},
