...
# Services-column tab switcher (SERVICES | STATUS) + the STATUS pane's difficulty header.
const OUTPOST_TAB_SERVICES := "SERVICES"
const OUTPOST_TAB_STATUS := "STATUS"
const OUTPOST_STATUS_DIFFICULTY := "DIFFICULTY %+d"
