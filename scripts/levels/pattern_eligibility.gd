...
const DATA := {
	"res://scenes/enemies/core/enemy_bomb_drone.tscn": {"identity": "straight", "eligible": ["straight", "straight_charge", "hunt_beeline"]},
	"res://scenes/enemies/core/enemy_bomber.tscn": {"identity": "drift", "eligible": ["drift"]},
	"res://scenes/enemies/core/enemy_cruiser.tscn": {"identity": "loiter", "eligible": ["drift", "loiter"]},
	"res://scenes/enemies/core/enemy_crystal.tscn": {"identity": "loiter", "eligible": ["loiter"]},
	"res://scenes/enemies/factions/corporate/enemy_bulwark.tscn": {"identity": "drift", "eligible": ["drift"]},
	...
	"res://scenes/enemies/factions/corporate/enemy_drone_carrier.tscn": {"identity": "loiter", "eligible": ["loiter", "side_traverse"]},
	"res://scenes/enemies/factions/corporate/enemy_hunter_drone.tscn": {"identity": "hunt_beeline", "eligible": ["hunt_beeline", "straight", "straight_charge"]},
	"res://scenes/enemies/factions/corporate/enemy_sapper.tscn": {"identity": "hunt_omni", "eligible": ["hunt_omni"]},
	"res://scenes/enemies/factions/privateer/enemy_dart.tscn": {"identity": "straight", "eligible": ["straight", "straight_charge"]},
	"res://scenes/enemies/factions/privateer/enemy_gunship.tscn": {"identity": "hunt_omni", "eligible": ["loiter", "hunt_omni", "straight"]},
	"res://scenes/enemies/factions/privateer/enemy_interceptor.tscn": {"identity": "side_dive", "eligible": ["side_dive", "straight", "straight_charge", "side_turn", "lane_cut", "lane_shift"]},
	"res://scenes/enemies/factions/privateer/enemy_minelayer.tscn": {"identity": "side_traverse", "eligible": ["side_traverse", "lane_weave", "lane_drift", "lane_shift", "lane_cut", "drift"]},
	...
	"res://scenes/enemies/factions/privateer/enemy_p_s_drop.tscn": {"identity": "straight", "eligible": ["lane_cut", "lane_drift", "lane_shift", "lane_weave", "straight"]},
	"res://scenes/enemies/factions/privateer/enemy_p_s_gray.tscn": {"identity": "straight", "eligible": ["straight", "lane_drift", "lane_shift", "proximity_chase"]},
	"res://scenes/enemies/factions/privateer/enemy_p_s_green.tscn": {"identity": "straight", "eligible": ["straight", "lane_drift", "lane_weave", "straight_charge", "side_turn", "side_dive"]},
	"res://scenes/enemies/factions/privateer/enemy_rocket.tscn": {"identity": "straight", "eligible": ["straight", "loiter", "straight_charge", "loiter_sweep"]},
