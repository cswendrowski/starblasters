...
const DATA := {
	...
	"res://scenes/enemies/factions/privateer/enemy_p_m_widow.tscn": {"identity": "loiter", "eligible": ["loiter"]},
	"res://scenes/enemies/factions/corporate/enemy_c_l_bulwark.tscn": {"identity": "drift", "eligible": ["drift"]},
	"res://scenes/enemies/factions/corporate/enemy_c_s_curve.tscn": {"identity": "lane_cut", "eligible": ["lane_cut", "lane_drift", "lane_shift", "lane_weave", "side_dive", "straight_charge", "straight"]},
	"res://scenes/enemies/factions/corporate/enemy_c_s_hold.tscn": {"identity": "skirmish_figure8", "eligible": ["lane_hook", "loiter", "skirmish_figure8", "skirmish_loop"]},
	"res://scenes/enemies/factions/corporate/enemy_c_l_hive.tscn": {"identity": "loiter", "eligible": ["loiter", "side_traverse"]},
	"res://scenes/enemies/factions/corporate/enemy_c_s_sapper.tscn": {"identity": "hunt_omni", "eligible": ["hunt_omni"]},
	"res://scenes/enemies/core/enemy_core_s_dart.tscn": {"identity": "straight", "eligible": ["straight", "straight_charge"]},
	"res://scenes/enemies/core/enemy_core_s_flechette.tscn": {"identity": "straight", "eligible": ["straight", "straight_charge"]},
	"res://scenes/enemies/factions/privateer/enemy_p_m_gunship.tscn": {"identity": "hunt_omni", "eligible": ["loiter", "hunt_omni", "straight"]},
	"res://scenes/enemies/factions/privateer/enemy_p_m_interceptor.tscn": {"identity": "side_dive", "eligible": ["side_dive", "straight", "straight_charge", "side_turn", "lane_cut", "lane_shift"]},
	...
	"res://scenes/enemies/core/enemy_core_s_caltrop.tscn": {"identity": "straight", "eligible": ["lane_cut", "lane_drift", "lane_shift", "lane_weave", "straight"]},
	"res://scenes/enemies/core/enemy_core_s_cobra.tscn": {"identity": "straight", "eligible": ["straight", "lane_drift", "lane_shift", "proximity_chase"]},
	"res://scenes/enemies/factions/privateer/enemy_core_s_falchion.tscn": {"identity": "straight", "eligible": ["straight", "lane_drift", "lane_weave", "straight_charge", "side_turn", "side_dive"]},
	"res://scenes/enemies/factions/privateer/enemy_p_m_rocket.tscn": {"identity": "straight", "eligible": ["straight", "loiter", "straight_charge", "loiter_sweep"]},
	...
	"res://scenes/enemies/factions/supremacy/enemy_s_s_hotrod.tscn": {"identity": "straight", "eligible": ["side_dive", "straight", "straight_charge", "lane_drift", "lane_shift", "lane_cut", "side_turn"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_s_rush.tscn": {"identity": "hunt_beeline", "eligible": ["hunt_beeline", "lane_weave", "side_dive", "lane_shift", "lane_drift", "straight_charge", "straight", "lane_cut", "side_turn"]},
	...
	"res://scenes/enemies/factions/zealot/enemy_z_l_crusader.tscn": {"identity": "loiter", "eligible": ["loiter", "side_traverse", "drift", "straight"]},
	...
	"res://scenes/enemies/factions/zealot/enemy_z_s_censer.tscn": {"identity": "loiter", "eligible": ["loiter", "drift", "straight"]},
	"res://scenes/enemies/factions/zealot/enemy_z_s_crook.tscn": {"identity": "straight", "eligible": ["straight", "side_dive", "lane_drift"]},
	"res://scenes/enemies/factions/zealot/enemy_z_s_cross.tscn": {"identity": "hunt_omni", "eligible": ["hunt_omni", "straight", "loiter"]},
	"res://scenes/enemies/factions/zealot/enemy_z_s_pilgrim.tscn": {"identity": "loiter", "eligible": ["loiter", "straight"]},
	"res://scenes/enemies/factions/zealot/enemy_z_s_rebuker.tscn": {"identity": "loiter", "eligible": ["loiter", "straight", "drift"]},
	"res://scenes/enemies/factions/zealot/enemy_z_s_spear.tscn": {"identity": "straight", "eligible": ["straight", "side_dive"]},
	"res://scenes/enemies/factions/supremacy/enemy_frigate.tscn": {"identity": "side_traverse", "eligible": ["side_traverse", "loiter", "drift"]},
}
