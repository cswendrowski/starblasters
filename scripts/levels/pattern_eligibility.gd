...
const DATA := {
	...
	"res://scenes/enemies/factions/corporate/enemy_c_l_bulwark.tscn": {"identity": "drift", "eligible": ["drift", "straight", "lane_weave", "lane_drift", "lane_shift", "lane_hook"]},
	...
	"res://scenes/enemies/factions/corporate/enemy_c_s_hold.tscn": {"identity": "lane_hook", "eligible": ["lane_hook", "loiter", "skirmish_figure8", "skirmish_loop", "skirmish_pendulum", "straight"]},
	...
	"res://scenes/enemies/factions/privateer/enemy_p_m_interceptor.tscn": {"identity": "straight_charge", "eligible": ["straight_charge", "side_turn", "straight", "lane_cut", "lane_shift"]},
	...
	"res://scenes/enemies/factions/zealot/boss_z_battleship.tscn": {"identity": "loiter", "eligible": ["loiter", "drift", "straight", "side_traverse"]},
	...
	# New supremacy units (Roman 2026-07-07 eligibility pass; some identities/eligibles are authored path_<name> keys).
	"res://scenes/enemies/factions/supremacy/enemy_s_s_striker.tscn": {"identity": "straight", "eligible": ["straight", "side_turn", "side_traverse", "path_dive_diagonal", "path_skirmish_loop", "path_skirmish_figure8"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_s_piercer.tscn": {"identity": "lane_drift", "eligible": ["lane_drift", "lane_shift", "lane_weave", "hunt_beeline"]},
	...
	"res://scenes/enemies/factions/supremacy/enemy_s_m_chaser.tscn": {"identity": "path_dive_diagonal", "eligible": ["path_dive_diagonal", "loiter", "straight"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_m_hunter.tscn": {"identity": "straight_charge", "eligible": ["straight_charge", "lane_drift", "lane_shift", "lane_weave", "straight"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_m_breaker.tscn": {"identity": "side_turn", "eligible": ["side_turn", "lane_cut", "lane_drift", "lane_shift", "loiter"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_m_ravager.tscn": {"identity": "loiter", "eligible": ["loiter", "straight"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_m_ruiner.tscn": {"identity": "loiter", "eligible": ["loiter", "straight", "path_back_and_forth_wide"]},
