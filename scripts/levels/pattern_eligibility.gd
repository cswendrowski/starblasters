...
const DATA := {
	...
	"res://scenes/enemies/factions/privateer/enemy_core_s_falchion.tscn": {"identity": "straight", "eligible": ["straight", "lane_drift", "lane_weave", "straight_charge", "side_turn", "side_dive", "hunt_beeline", "lane_cut", "lane_hook"]},
	...
	"res://scenes/enemies/core/enemy_core_s_jet.tscn": {"identity": "lane_cut", "eligible": ["lane_cut", "lane_weave", "side_dive", "straight", "straight_charge"]},
	"res://scenes/enemies/factions/privateer/enemy_p_m_wing.tscn": {"identity": "drift", "eligible": ["drift", "side_dive", "side_traverse", "straight", "straight_charge"]},
}
