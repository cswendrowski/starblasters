...
const DATA := {
	...
	"res://scenes/enemies/core/enemy_bomber.tscn": {"identity": "drift_mid", "eligible": ["drift_mid"]},
	"res://scenes/enemies/core/enemy_cruiser.tscn": {"identity": "drift_high", "eligible": ["drift_high"]},
	...
	"res://scenes/enemies/factions/corporate/enemy_drone_carrier.tscn": {"identity": "drift_high", "eligible": ["drift_high"]},
	...
	"res://scenes/enemies/factions/privateer/enemy_interceptor.tscn": {"identity": "side_dive", "eligible": ["side_dive"]},
	...
	"res://scenes/enemies/factions/supremacy/enemy_s_s_hotrod.tscn": {"identity": "straight_fast", "eligible": ["lane_weave", "side_dive", "straight_fast"]},
	"res://scenes/enemies/factions/supremacy/enemy_s_s_rush.tscn": {"identity": "hunt_beeline", "eligible": ["hunt_beeline", "lane_weave", "side_dive"]},
	"res://scenes/enemies/factions/zealot/enemy_beam_shooter.tscn": {"identity": "beam_sweep", "eligible": ["beam_sweep"]},
