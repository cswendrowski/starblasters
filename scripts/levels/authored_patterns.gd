...
# The committed pattern library — authored + exported by the wave pattern editor. Seeded with
# one example (a delayed V-pincer of conductor-filled small enemies) so the auto-mix has
# something to draw and the dict format is self-documenting.
const DATA: Array = [
	{
		...
		"stagger": 0.18,
		"placements": [
			{"lane": 0, "row": 0, "enemy": "", "movement": "", "size": "small"},
			{"lane": 6, "row": 0, "enemy": "", "movement": "", "size": "small"},
			{"lane": 1, "row": 1, "enemy": "", "movement": "", "size": "small"},
			{"lane": 5, "row": 1, "enemy": "", "movement": "", "size": "small"},
			{"lane": 2, "row": 2, "enemy": "", "movement": "", "size": "small"},
			{"lane": 4, "row": 2, "enemy": "", "movement": "", "size": "small"},
			{"lane": 3, "row": 3, "enemy": "", "movement": "", "size": "small"},
		],
	},
]
